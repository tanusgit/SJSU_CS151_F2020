...
public class BusinessTest {
	public static void main(String[] args) {
		...
		Executive ex1 = new Executive("Sara", "Williams", a1, 1, 123456.0, 20000.0 );
		ex1.setSSN("45652");
		ex1.introduce(true);
		...
		Executive ex2 = new Executive("Kara", "Williams", a2, 2, 120456.0, 22000.0 );
		ex2.introduce(true);
		Double pay1 = ex2.computePay();
		System.out.println("pay is " + pay1);
		System.out.println();
		
		FullTimeSalaried ex3 = new FullTimeSalaried("Lara", "Williams", a3, 200000.0 );
		ex3.introduce(true);
		Double pay2 = ex3.computePay(23);
		System.out.println("pay is " + pay2);
		System.out.println();
		
		FullTimeSalaried ex4 = new FullTimeSalaried("Mara", "Williams", a4, 300000.0 );
		ex4.introduce(true);
		Double pay3 = ex4.computePay(23);
		System.out.println("pay is " + pay3);
		System.out.println();
		
		FullTimeHourly ex5 = new FullTimeHourly("Para", "Williams", a5,3 , 600000.0, 300000.0 );
		ex5.introduce(true);
		Double pay4 = ex5.computePay(23);
		System.out.println("pay is " + pay4);
		System.out.println();
		
		FullTimeHourly ex6 = new FullTimeHourly("Aara", "Williams", a6,4 , 600000.0, 300000.0 );
		ex6.introduce(true);
		...
		PartTimeHourly ex11 = new PartTimeHourly("Sirish", "Williams", a11,445236.0);
		ex11.introduce(true);
		Double pay8 = ex11.computePay(23);
		System.out.println("pay is " + pay8);
		System.out.println();
		
		PartTimeHourly ex12 = new PartTimeHourly("Arun", "Williams", a12,485463.0 );
		ex12.introduce(true);
